...
from users.manager import MiFinanzaUserManager

# Create your models here.


class MiFinanzaBaseUser(AbstractBaseUser, PermissionsMixin):
    """
...
class MiFinanzaAbstractBaseUser(BaseModel, MiFinanzaBaseUser):
